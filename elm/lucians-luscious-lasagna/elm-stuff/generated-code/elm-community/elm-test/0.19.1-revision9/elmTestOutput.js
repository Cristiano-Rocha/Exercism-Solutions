...
var $author$project$LuciansLusciousLasagna$preparationTimeInMinutes = function (layer) {
	return layer * 2;
};
var $author$project$LuciansLusciousLasagna$elapsedTimeInMinutes = F2(
	function (layers, ovenTime) {
		return ovenTime + $author$project$LuciansLusciousLasagna$preparationTimeInMinutes(layers);
	});
...
var pipeFilename = "/tmp/elm_test-82185.sock";
var net = require('net'),
